...
export const mockEvaluationMgmtData: EvaluationMgmtModel[] = [
  ...
  },
  {
    ...
    dataSetId: null,
    experimentId: "99",
    runId: "test-deployed-model-001",
    modelName: "已测试部署模型A-水质预测",
    taskName: "deployed-model-a",
    trainTime: 12000,
    inputJson: null,
    evaluateIndex: JSON.stringify([
      { desc: "平均绝对误差（MAE）", name: "mae", value: "0.35" },
      { desc: "拟合度（r2_score）", name: "r2_score", value: "0.95" },
      { desc: "准确率", name: "accuracy", value: "0.92" },
    ]),
    notes: "已通过测试部署的模型",
    creator: "测试用户",
    version: "V002",
  ...
  },
  {
    ...
    dataSetId: null,
    experimentId: "98",
    runId: "test-deployed-model-002",
    modelName: "已测试部署模型B-设备预测",
    taskName: "deployed-model-b",
    trainTime: 15000,
    inputJson: null,
    evaluateIndex: JSON.stringify([
      { desc: "准确率", name: "accuracy", value: "0.94" },
      { desc: "精确率", name: "precision", value: "0.91" },
      { desc: "召回率", name: "recall", value: "0.89" },
      { desc: "F1分数", name: "f1Score", value: "0.90" },
    ]),
    notes: "已通过测试部署的分类模型",
    creator: "测试用户",
    version: "V001",
    ...
    status: null,
    statusName: "完成",
    createTime: "2025-12-19 15:30:00",
    updateTime: null,
    deleted: null,
    updateUser: null,
    modelType: "机器学习-分类",
    applicableScenarioStr: "设备故障预测",
    deployTestStatus: 1,
    runCount: "3"
  }
];
