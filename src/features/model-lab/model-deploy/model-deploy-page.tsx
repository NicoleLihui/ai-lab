  ...
  const mockData: ModelDeployment[] = [
    {
      ...
      modelName: '客户流失预测模型',
      version: 'v1.2.0',
      deploymentName: 'customer-churn-prod',
      status: 'running',
      endpoint: 'https://api.example.com/models/customer-churn',
    ...
    },
    {
      ...
      modelName: '销售预测模型',
      version: 'v2.1.0',
      deploymentName: 'sales-forecast-staging',
      status: 'stopped',
      endpoint: 'https://api.example.com/models/sales-forecast',
    ...
    },
    {
      ...
      modelName: '信用评分模型',
      version: 'v1.0.5',
      deploymentName: 'credit-score-dev',
      status: 'failed',
      endpoint: 'https://api.example.com/models/credit-score',
    ...
    },
    {
      ...
      modelName: '需求预测模型',
      version: 'v1.1.2',
      deploymentName: 'demand-forecast-prod',
      status: 'running',
      endpoint: 'https://api.example.com/models/demand-forecast',
    ...
    },
    {
      ...
      modelName: '欺诈检测模型',
      version: 'v1.3.0',
      deploymentName: 'fraud-detection-realtime',
      status: 'pending',
      endpoint: 'https://api.example.com/models/fraud-detection',
